    ...
    const flexMessage = {
        ...
        contents: {
            ...
            "header": {
                ...
                "layout": "vertical",
                "contents": [
                    { "type": "text", "text": "OFFICIAL MATCH REPORT", "weight": "bold", "color": "#FFFFFF", "size": "xxs", "align": "center", "letterSpacing": "2px" },
                    { "type": "text", "text": "สรุปผลการแข่งขัน", "weight": "bold", "size": "xl", "margin": "md", "color": "#FFFFFF", "align": "center" }
                ],
            ...
            "hero": {
                ...
                "contents": [
                    ...
                    {
                        "type": "text",
                        "text": match.roundLabel ? match.roundLabel.split(':')[0] : "การแข่งขัน",
                        "size": "xs",
                        "color": "#94a3b8",
                        "align": "center",
                        "margin": "sm"
...
export const sharePlayerCardFlex = async (player: Player, team: Team, stats: any) => {
    ...
    // Determine colors
    let mainColor = "#fbbf24"; // Default Gold
    try {
        if (team.color) {
             const c = team.color.startsWith('[') ? JSON.parse(team.color)[0] : team.color;
             if (c) mainColor = c;
        }
    } catch(e) {}
    ...
    const createStatRow = (l1: string, v1: number, l2: string, v2: number) => ({
        ...
        "layout": "horizontal",
        "contents": [
            { "type": "text", "text": `${v1}`, "weight": "bold", "color": "#fbbf24", "flex": 1, "align": "end", "size": "sm" },
            { "type": "text", "text": l1, "size": "xxs", "color": "#94a3b8", "flex": 1, "margin": "sm", "align": "start", "gravity": "center" },
            { "type": "text", "text": `${v2}`, "weight": "bold", "color": "#fbbf24", "flex": 1, "align": "end", "size": "sm" },
            { "type": "text", "text": l2, "size": "xxs", "color": "#94a3b8", "flex": 1, "margin": "sm", "align": "start", "gravity": "center" }
        ],
        "margin": "sm"
    });
    ...
    const flexMessage = {
        ...
        contents: {
            "type": "bubble",
            "styles": {
                "body": { "backgroundColor": "#1e293b" }, // Slate-800
            ...
            "body": {
                ...
                "layout": "vertical",
                "contents": [
                    // Top Section: Rating, Position, Logo
                    {
                        "type": "box",
                        "layout": "horizontal",
                        "contents": [
                            {
                                ...
                                "layout": "vertical",
                                "contents": [
                                    { "type": "text", "text": `${stats.ovr}`, "size": "3xl", "weight": "bold", "color": "#fbbf24", "lineHeight": "30px" },
                                    { "type": "text", "text": player.position ? player.position.substring(0,3).toUpperCase() : "PLY", "size": "xs", "weight": "bold", "color": "#ffffff" }
                                ],
                                "flex": 1
                            },
                            {
                                "type": "image",
                                "url": team.logoUrl || "https://via.placeholder.com/100?text=Logo",
                                "align": "end",
                                "size": "xs",
                                "aspectMode": "fit",
                                "flex": 1
